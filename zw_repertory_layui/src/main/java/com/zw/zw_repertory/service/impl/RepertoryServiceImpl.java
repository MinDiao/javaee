...
public class RepertoryServiceImpl implements RepertoryService {
	...
	public PageInfo repertorySelect(RepertoryDto repertoryDto) {
		...
		PageHelper.startPage(repertoryDto.getPage(), repertoryDto.getLimit());
	 ...
	 */
	@Override
	public RepertoryList repertorySelectById(String shopId) {
		
		return repertoryMapper.repertorySelectById(shopId);
	}
	 ...
	 */
	@Override
	public int repertoryDeleteById(Integer shopId) {
		
		return repertoryMapper.deleteByPrimaryKey(shopId);
	}
	 ...
	 */
	@Override
	public int repertoryDeleteByIds(String[] shopIds) {
		
		return repertoryMapper.repertoryDeleteByIds(shopIds);
	}
	 ...
	 */
	@Override
	public int repertoryUpdate(RepertoryCount repertoryCount) {
		
		return repertoryMapper.updateByPrimaryKeySelective(repertoryCount);
	}
